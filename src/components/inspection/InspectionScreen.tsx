...
const equipmentTypes: Array<{
  ...
  { type: 'heat_sensor_2', label: '煙感知器2種', iconPath: '/icons/kemurikanchiki_2shu.svg', color: 'gray' },
  { type: 'heat_sensor_3', label: '煙感知器3種', iconPath: '/icons/kemurikanchiki_3shu.svg', color: 'gray' },
  { type: 'fire_extinguisher', label: '消火器', iconPath: '/icons/syoukaki.svg', color: 'red' },
  { type: 'indoor_hydrant', label: '屋内消火栓', iconPath: '/icons/ara-muben.svg', color: 'blue' },
  ...
  { type: 'emergency_light_arrow', label: '誘導灯（矢印）', iconPath: '/icons/yuudoutou_yazirushiari.svg', color: 'yellow' },
  { type: 'fire_alarm_waterproof', label: '火災報知器（防水）', iconPath: '/icons/kasaihouchiki_bousui.svg', color: 'red' },
  { type: 'fire_alarm_2', label: '火災報知器2種', iconPath: '/icons/kasaihouchiki_nishu.svg', color: 'red' },
  { type: 'fire_alarm_special', label: '火災報知器特種', iconPath: '/icons/kasaihouchiki_tokushu.svg', color: 'red' },
  { type: 'emergency_alarm', label: '非常警報装置', iconPath: '/icons/hizyoukeihousouchi.svg', color: 'orange' },
