...
const equipmentTypes: Array<{
  ...
  { type: 'fire_alarm_waterproof', label: '熱感（防水）', iconPath: '/icons/kasaihouchiki_bousui.svg', color: 'red' },
  { type: 'fire_alarm_2', label: '熱感2種', iconPath: '/icons/kasaihouchiki_nishu.svg', color: 'red' },
  { type: 'fire_alarm_special', label: '熱感特種', iconPath: '/icons/kasaihouchiki_tokushu.svg', color: 'red' },
